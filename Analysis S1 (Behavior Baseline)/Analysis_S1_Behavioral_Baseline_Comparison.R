...
# subsetting data frame, exluding relevant actions
...
# save.image("Analysis_S1_Behavioral_Baseline_Comparison.RData")
#load("Analysis_S1_Behavioral_Baseline_Comparison.RData")
...
#save.image("./Analysis S1 (Behavior Baseline)_not_finished/Analysis_S1_Behavioral_Baseline_Comparison.RData")
